...
class TeamController {
    ...
    public function getById(Request $request, Response $response, array $params){
        ...
        $data['player'] = $this->playerRepository->getByTeamId($teamId);
    ...
    public function getByGroup(Request $request, Response $response, array $params){
        ...
        $data['grupo'] = $this->teamRepository->getByGroup($grupo);

        return $this->container->view->render($response, 'grupo.php', $data);
    }
}
